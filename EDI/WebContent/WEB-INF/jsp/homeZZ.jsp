	...
	<form id="form" class="form-horizontal" style="margin-bottom: 30px;">
		<div class="row"><label class="col-md-12">進口商資料</label></div>
				<div style="border: solid black;padding: 20px;border-radius: 10px;color: black;">
					...
					<div class="col-md-2">
					<input id="IMPORTER_NUM" name="IMPORTER_NUM" value="20190720110" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					<label class="col-md-2 control-label">名稱：</label>
					<div class="col-md-2">
					<input id="IMPORTER_NAME" name="IMPORTER_NAME" value="陳記" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
			</div>
				...
				<div  style="padding: 20px;padding-top:0;padding-bottom:0;border-radius: 10px;color: black;">
					...
					<div class="col-md-2">
					<input id="GOODS_AREA" name="GOODS_AREA" value="毛里求斯" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					<label class="col-md-2 control-label" for="title">總毛重（KG）：</label>
					<div class="col-md-2">
					<input id="WEIGHT" name="WEIGHT" value="1080" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
			</div>
			...
			<div  style="padding: 20px;padding-top:0;padding-bottom:0;border-radius: 10px;color: black;">
					...
					<div class="col-md-2">
					<input id="DRIVER_ID" name="DRIVER_ID" value="CA8738" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					<label class="col-md-2 control-label" for="title">貨櫃編號：</label>
					<div class="col-md-2">
					<input id="COUNTER_ID" name="COUNTER_ID" value="8976-2342-765ct" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					<label class="col-md-2 control-label" for="title">車輛編號：</label>
					<div class="col-md-2">
					<input id="CAR_ID" name="CAR_ID" value="VS983-90" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
			</div>
				...
				<div style="border: solid black;padding: 20px;border-radius: 10px;color: black;">
					...
					<div class="col-md-2">
					<input id="TYPE_ID" name="TYPE_ID" value="藥品" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
					<div class="form-group">
					...
					<div class="col-md-2">
					<input id="PACK_TYPE" name="PACK_TYPE" value="盒裝" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
					<div class="form-group">
					<label class="col-md-2 control-label">包裝數量：</label>
					<div class="col-md-2">
					<input  id="PACK_NUM" name="PACK_NUM" value="600" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					<label class="col-md-2 control-label">淨重（公斤）：</label>
					<div class="col-md-2">
					<input  id="GOODS_WEIGHT" name="GOODS_WEIGHT" value="1080" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					</div>
					<div class="form-group">
					<label class="col-md-2 control-label">數量：</label>
					<div class="col-md-2">
					<input  id="GOODS_NUM" name="GOODS_NUM" value="6000" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					...
					<div class="col-md-2">
					<input  id="GOODS_PRICE" name="GOODS_PRICE" value="103848" class="form-control input-small input-inline" type="text" style=""/>
					</div>
					...
					<label class="col-md-2 control-label">稅款：</label>
                    <div class="col-md-2">
                    <input  id="TAX" name="TAX" value="1038.48" class="form-control input-small input-inline" type="text" style=""/>
                    </div>
					</div>
			</div>
			</div>
